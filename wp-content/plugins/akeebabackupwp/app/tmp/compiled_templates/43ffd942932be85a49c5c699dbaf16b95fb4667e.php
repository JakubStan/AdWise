<?php /* C:\xampp\htdocs\AdWise\wp-content\plugins\akeebabackupwp\app\Solo\ViewTemplates\Configuration\confwiz_modal.blade.php */ ?>
<?php
/**
 * @package   solo
...
<div id="akeeba-config-confwiz-bubble" class="modal fade" role="dialog"
    ...
    <div class="akeeba-renderer-fef <?php echo ($this->getContainer()->appConfig->get('darkmode', -1) == 1) ? 'akeeba-renderer-fef--dark' : '' ?>">
        <h4>
            <?php echo $this->getLanguage()->text('COM_AKEEBA_CONFIG_HEADER_CONFWIZ'); ?>
        </h4>
        <div>
            <p>
                <?php echo $this->getLanguage()->text('COM_AKEEBA_CONFIG_LBL_CONFWIZ_INTRO'); ?>
            </p>
            <p>
                <a href="<?php echo $this->container->router->route('index.php?view=wizard'); ?>"
                   class="akeeba-btn--green akeeba-btn--big">
                    ...
                    <?php echo $this->getLanguage()->text('COM_AKEEBA_CONFWIZ'); ?>
                </a>
            </p>
            <p>
                <?php echo $this->getLanguage()->text('COM_AKEEBA_CONFIG_LBL_CONFWIZ_AFTER'); ?>
            </p>
        </div>
        <div>
